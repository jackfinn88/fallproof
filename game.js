...
TheGame.prototype = {
     preload: function() {
          game.stage.backgroundColor = '#1b1b1b';
	...
	addTile: function(row, col) {
     ...
     rotateField: function (a) {
          if (!rotations) return; else rotations--;
          ...
          if (this.canPick){
               ...
               rotateTween.onComplete.add(function () {    
                    ...
                    message = { rotate: true };
                    window.parent.window.postMessage(JSON.stringify(message), 'https://jlf40.brighton.domains/ci301/app/porthub/');
               }, this);
          }
     },
